...
public class TransactionRepository extends SimpleJpaRepository<Transaction, UUID> implements ITransactionRepository {
    ...
    public TransactionRepository(@Autowired EntityManager em) {
    ...
    public List<Transaction> findTransactionsByAmounts(UUID accountId,double minAmount, double maxAmount){
